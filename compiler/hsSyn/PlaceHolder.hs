...
type family PostTc id ty where  -- Note [Pass sensitive types]
  PostTc Id       ty = ty
  PostTc Name    _ty = PlaceHolder
  PostTc RdrName _ty = PlaceHolder

-- | Types that are not defined until after renaming
type family PostRn id ty where  -- Note [Pass sensitive types]
  PostRn Id       ty = ty
  PostRn Name     ty = ty
  PostRn RdrName _ty = PlaceHolder
